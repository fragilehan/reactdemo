export default {
	...
	CREATE_CARD_SUCCESS:'carete card success',
	...
	PRESIST_CARD_DRAG: 'persist card drag',
	PRESIST_CARD_DRAG_SUCCESS: 'persist card drag success',
	PRESIST_CARD_DRAG_ERROR: 'persist card drag error',
